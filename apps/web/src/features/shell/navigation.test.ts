...
describe("operator navigation", () => {
  ...
  it("maps tenant modules independently from human permissions", () => {
    expect(requiredFeatureForHref("/leads")).toBe("leads");
    expect(requiredFeatureForHref("/tickets/fixture")).toBe("tickets");
